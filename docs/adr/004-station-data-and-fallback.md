...
- The station's `rg1` column sums to 10.6 mm over the file, while its running daily total `rg1tt` gives 179.4 mm. We read rain from the daily total's increments (it resets at ~09:05 EAT).
- Gauge 2's daily total rises in daylight and falls at night, going backwards 375 times. It is marked unreliable and never used, not even to fill gaps.
